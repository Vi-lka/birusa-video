    ...
    React.useEffect(() => {
        ...
        setNodes([
            ...
            },
            {
                ...
                data: {
                    idTo: 255,
                    title: 'Написать заявление на отпуск',
                    target: Position.Left,
                    source: Position.Right,
                    personId: 2,
                    onClick: handleClick,
